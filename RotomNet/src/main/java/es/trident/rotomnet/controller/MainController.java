...
/**
 * MainController: Controller dedicado a gestionar la petición de la página principal, 
 * así como de la llamada al servicio dbManagementService para poblar la base de datos
 * con información por defecto.
 */
@Controller
