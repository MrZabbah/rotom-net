...
public interface PokemonRepository extends JpaRepository<Pokemon, Integer>{
	...
	@Query("SELECT p FROM Pokemon p WHERE (p.type1 = ?1 or p.type2 = ?2)and p.legendary = ?3")
	List<Pokemon> findByTypesAndLegendary(String _type1, String _type2, boolean _legendary);
}
